...
import UpgradeToAgencyModal from './UpgradeToAgencyModal';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Become a Partner Button - Only for Clients */}
              {user && (user.role === 'CLIENT' || user.role === 'ROLE_CLIENT') && (
                <button
                  onClick={() => setIsUpgradeModalOpen(true)}
                  className="hidden md:flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full hover:shadow-lg hover:scale-105 transition-all text-sm font-semibold"
                >
